...
router.post('/:id/register', 
    validation({ params: eventIdParamSchema, body: eventRegistrationSchema }), 
    eventController.registerForEvent
);
router.delete('/:id/register', 
    validation({ params: eventIdParamSchema }), 
...
router.get('/', 
    ...
    validation({ query: getEventsQuerySchema }), 
...
router.patch('/:id', 
    authenticate(), 
    authorize(['admin', 'governorate_user']),
    validation({ params: eventIdParamSchema, body: updateEventSchema }), 
...
router.patch('/:id/toggle-published', 
    ...
    authorize(['admin']),
    validation({ params: eventIdParamSchema }), 
    eventController.togglePublished
);
...
router.patch('/registrations/:registrationId', 
    authenticate(), 
    authorize(['admin', 'governorate_user']),
    validation({ body: updateRegistrationStatusSchema }), 
